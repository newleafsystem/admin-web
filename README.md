...
- AI review and recommendation generation: `AI_PROVIDER`, `OPENAI_API_KEY`, `AI_API_KEY`, `AI_BASE_URL`, `AI_MODEL`, `AI_TRANSCRIPTION_MODEL`
- Calculated recommendation context: `NEWLEAF_MARKET_API_BASE_URL`, `NEWLEAF_MARKET_API_KEY`, `NEWLEAF_MARKET_API_MODEL_MODE`, `ALPACA_API_KEY`, `ALPACA_SECRET_KEY`, `ALPACA_DATA_BASE_URL`, `PUBLIC_DATA_ORIGIN_URL`
- Recommendation PDF reports: `RECOMMENDATION_PDF_RENDERER`, `WEASYPRINT_PYTHON_PATH`, `CHROME_PATH`, `RECOMMENDATION_PDF_RENDER_TIMEOUT_MS`, `RECOMMENDATION_PDF_FALLBACK_TO_LEGACY`
