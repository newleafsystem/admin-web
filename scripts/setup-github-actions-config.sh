...
derive_defaults() {
  ...
  PUBLIC_DATA_ORIGIN_URL="${PUBLIC_DATA_ORIGIN_URL:-${R2_PUBLIC_BASE_URL:-}}"
}

derive_defaults

require_value GCS_BUCKET
require_value PUBLIC_DATA_ORIGIN_URL
require_value PUBLIC_MEDIA_ORIGIN_URL
require_value ALPACA_API_KEY
require_value ALPACA_SECRET_KEY
...
set_secret_value PUBLIC_DATA_ORIGIN_URL "${PUBLIC_DATA_ORIGIN_URL:-${R2_PUBLIC_BASE_URL:-}}"
set_secret_value PUBLIC_MEDIA_ORIGIN_URL "${PUBLIC_MEDIA_ORIGIN_URL:-}"
set_variable PUBLIC_ASSET_CACHE_MAX_AGE_SEC "${PUBLIC_ASSET_CACHE_MAX_AGE_SEC:-300}"
set_variable ALPACA_DATA_BASE_URL "${ALPACA_DATA_BASE_URL:-https://data.alpaca.markets}"
...
set_variable AUTH_SESSION_HINT_COOKIE_NAME "${AUTH_SESSION_HINT_COOKIE_NAME:-newleaf_session_hint}"
set_variable AUTH_SESSION_COOKIE_DOMAIN "${AUTH_SESSION_COOKIE_DOMAIN:-.newleafsystem.com}"
set_variable AUTH_SESSION_COOKIE_PATH "${AUTH_SESSION_COOKIE_PATH:-/}"
...
set_variable PUBLIC_BASE_URL "${PUBLIC_BASE_URL:-https://api.newleafsystem.com}"
set_variable ADMIN_BASE_URL "${ADMIN_BASE_URL:-https://admin.newleafsystem.com}"
set_variable SOCIAL_CALLBACK_BASE_URL "${SOCIAL_CALLBACK_BASE_URL:-${PUBLIC_BASE_URL:-https://api.newleafsystem.com}}"
set_variable CORS_ALLOWED_ORIGINS "${CORS_ALLOWED_ORIGINS:-${ADMIN_BASE_URL:-https://admin.newleafsystem.com} https://newleafsystem.com https://www.newleafsystem.com https://preview.newleafsystem.com}"
set_variable VITE_FIREBASE_API_KEY "${VITE_FIREBASE_API_KEY:-}"
set_variable VITE_API_BASE_URL "${VITE_API_BASE_URL:-https://api.newleafsystem.com/api/v1}"
set_variable VITE_FIREBASE_AUTH_DOMAIN "${VITE_FIREBASE_AUTH_DOMAIN:-api.newleafsystem.com}"
...
set_secret_value ALPACA_API_KEY "${ALPACA_API_KEY}"
set_secret_value ALPACA_SECRET_KEY "${ALPACA_SECRET_KEY}"
