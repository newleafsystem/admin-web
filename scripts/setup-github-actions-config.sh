...
set_variable CORS_ALLOWED_ORIGINS "${CORS_ALLOWED_ORIGINS:-${ADMIN_BASE_URL:-https://admin.newleafsystem.com} https://newleafsystem.com https://www.newleafsystem.com https://newleafsystem.web.app https://newleaf-preview.web.app}"
set_variable VITE_FIREBASE_API_KEY "${VITE_FIREBASE_API_KEY:-}"
set_variable VITE_FIREBASE_AUTH_DOMAIN "${VITE_FIREBASE_AUTH_DOMAIN:-admin.newleafsystem.com}"
